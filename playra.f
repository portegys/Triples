      SUBROUTINE PLAYRA(POSA,POSB,RULTAB,RET)
C
C THIS SUBROUTINE MAKES A TRIPLES MOVE USING A
C VARIABLE PLY MINIMX LOOK-AHEAD WITH ALPHA-BETA PRUNING.
C
...
C
C PERFORM THE MINIMX PROCEDURE AT THE NEXT HIGHER LEVEL.
      CALL MINIMX
      LVLPTR = LVLPTR - 1
      GO TO 90
...
152   CONTINUE
      ...
      SUBROUTINE MINIMX
C
C THIS SUBROUTINE PERFORMS THE MINIMX PROCEDURE OF BRINGING VALUES
...
C
     ...
     2MOVNDX(9),MOVSAV(9),MOVCNT(9),DEADLK,LVLIM
      ...
      INTEGER I,J,TLVL
C
C CHECK IF THE MINIMX IS COMPLETE.
      TLVL = LVLPTR - 1
